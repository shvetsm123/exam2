...
export const getAllPendingOffers = (data) => http.get('moderPanel', data);
export const getOneOffer = (data) => http.get('getOneOffer', data);
export const updateOfferModerStatus = (data) =>
  http.patch(`moderPanel/${data.offerId}`, data);
